...
public:
    ...
    CBlockIndex(const CBlockHeader& block)
    {
        ...
        pHeaderData->nCachedBranchId = boost::none;
        pHeaderData->hashSproutAnchor = uint256();
        pHeaderData->hashFinalSproutRoot = uint256();
        pHeaderData->nSproutValue = boost::none;
        pHeaderData->nChainSproutValue = boost::none;
        pHeaderData->nChainSaplingValue = boost::none;
    }
