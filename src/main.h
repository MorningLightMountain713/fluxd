...
static const unsigned int MAX_REORG_LENGTH = 40;
...
bool CheckTransaction(const CTransaction& tx, CValidationState& state, libflux::ProofVerifier& verifier);
