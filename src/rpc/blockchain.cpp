...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    UniValue valuePools(UniValue::VARR);
    if (tip->pHeaderData) {
        valuePools.push_back(ValuePoolDesc("sprout", tip->pHeaderData->nChainSproutValue, boost::none));
        valuePools.push_back(ValuePoolDesc("sapling", tip->pHeaderData->nChainSaplingValue, boost::none));
    }
