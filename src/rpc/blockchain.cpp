...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    valuePools.push_back(ValuePoolDesc("sprout",
        blockindex->pHeaderData ? blockindex->pHeaderData->nChainSproutValue : boost::none,
        blockindex->pHeaderData ? blockindex->pHeaderData->nSproutValue : boost::none));
    valuePools.push_back(ValuePoolDesc("sapling",
        blockindex->pHeaderData ? blockindex->pHeaderData->nChainSaplingValue : boost::none,
        blockindex->pHeaderData ? boost::optional<CAmount>(blockindex->pHeaderData->nSaplingValue) : boost::none));
...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    UniValue valuePools(UniValue::VARR);
    valuePools.push_back(ValuePoolDesc("sprout", tip->pHeaderData ? tip->pHeaderData->nChainSproutValue : boost::none, boost::none));
    valuePools.push_back(ValuePoolDesc("sapling", tip->pHeaderData ? tip->pHeaderData->nChainSaplingValue : boost::none, boost::none));
